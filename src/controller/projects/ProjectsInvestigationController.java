...
public class ProjectsInvestigationController extends Controller implements Initializable {
    ...
    @FXML private Button consultProjectButton;
    @FXML private Button btnExit;
    @FXML private TextField searchTextField;
    @FXML private TableView<Project> projectsTableView;
    @FXML private TableColumn<Project, String> nameProjectColumn;
    @FXML private TableColumn<Project, String> durationProjectColumn;
    @FXML private TableColumn<Project, String> statusProjectColumn;
    @FXML private TableColumn<Project, String> startDateProjectColumn;
    @FXML private TableColumn<Project, String> endDateProjectColumn;
