...
public class ConsultAcademicGroupsController extends Controller implements Initializable {
    @FXML private ListView<AcademicGroup> academicGroupProgramListView;
    @FXML private Label totalAcademicGroupProgramLabel;
    @FXML private TextField searchTextField;
    @FXML private Button registerAcademicGroupButton;
    private FilteredList<AcademicGroup> filteredData;

    @Override
    public void initialize(URL location, ResourceBundle resources) {
        if(Autentication.getInstance().getParticipation().getParticipationType() != ParticipationType.OTHER) {
            registerAcademicGroupButton.setVisible(false);
        }
