...
public class MemberSelectionController implements Initializable{
    ...
    private void addNewIntegrant(ActionEvent event){
        FXMLLoader loader = WindowControllerB.getWindowController().changeWindow("IntegrantEditable.fxml", btnCancel);
    ...
    private void addNewCollaborator(ActionEvent event){
        FXMLLoader loader = WindowControllerB.getWindowController().changeWindow("CollaboratorEditable.fxml", btnCancel);
