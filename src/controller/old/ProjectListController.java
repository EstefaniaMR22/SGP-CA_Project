...
public class ProjectListController implements Initializable{
    ...
    public void receiveToken(Integrant integrantToken){
        ...
        if(listProject != null){
            ...
            WindowControllerB.getWindowController().showErrorAlert(new ActionEvent(), "Lo sentimos, el sistema no está disponible, favor de contactar a soporte técnico");
    ...
    private void selectProject(MouseEvent event){
        ...
        if (projectSelected != null){
            FXMLLoader loader = WindowControllerB.getWindowController().changeWindow("Project.fxml", btnExit);
