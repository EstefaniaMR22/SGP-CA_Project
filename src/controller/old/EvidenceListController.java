...
public class EvidenceListController implements Initializable{
    ...
    private void addEvidence(ActionEvent event){
        FXMLLoader loader = WindowControllerB.getWindowController().changeWindow("EvidenceSelection.fxml", btnClose);
    ...
    private void closeWindow(ActionEvent event){
        FXMLLoader loader = WindowControllerB.getWindowController().changeWindow("Start.fxml", btnClose);
