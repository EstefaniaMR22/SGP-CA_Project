...
public class GeneralResumeRequestController implements Initializable{
    ...
    private void setGeneralResumeDataIntoInterface(){
        if(this.generalResume != null){
            ...
            WindowControllerB.getWindowController().showErrorAlert(new ActionEvent(), errorMessage);
    ...
    private void editGeneralResume(ActionEvent event){
        FXMLLoader loader = WindowControllerB.getWindowController().changeWindow("GeneralResumeEditable.fxml", btnExit);
    ...
    private void addMember(ActionEvent event){
        FXMLLoader loader = WindowControllerB.getWindowController().changeWindow("MemberSelection.fxml", btnExit);
    ...
    private void showIntegrant(MouseEvent event){
        ...
        if(integrant != null){
            FXMLLoader loader = WindowControllerB.getWindowController().changeWindow("IntegrantRequest.fxml", btnExit);
    ...
    private void showCollaborator(MouseEvent event){
        ...
        if(collaborator != null){
            FXMLLoader loader = WindowControllerB.getWindowController().changeWindow("CollaboratorRequest.fxml", btnExit);
