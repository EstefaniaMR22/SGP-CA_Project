...
public class PersonalResumeEditableController implements Initializable {
    ...
    private void updatePersonalResume(ActionEvent event){
        try{
            ...
            if(INTEGRANT_DAO.updateMember(this.integrantUpdated, token.getEmailUV())){
                WindowControllerB.getWindowController().showInfoAlert(event, "Currículum personal actualizado exitosamente");
            }else{
            ...
            FXMLLoader loader = WindowControllerB.getWindowController().changeWindow("PersonalResumeRequest.fxml", btnCancel);
    ...
    private void cancelUpdate(ActionEvent event){
        Optional<ButtonType> action = WindowControllerB.getWindowController().showConfirmacionAlert(event, "¿Seguro que deseas cancelar la operción?");
    ...
    private void setIntegrantDataIntoInterface(){
        ...
        if(integrant != null){
            ...
            WindowControllerB.getWindowController().showErrorAlert(new ActionEvent(), "Error en el sistema, favor de contactar con soporte técnico");
            FXMLLoader loader = WindowControllerB.getWindowController().changeWindow("Start.fxml", btnCancel);
