    ...
    private void addEvidence(ActionEvent event){
        try{
            ...
            if(EVIDENCE_DAO.addNewEvidence(this.evidence)){
                WindowControllerB.getWindowController().showInfoAlert(event, "Evidencia registrada con éxito");
            }else{
    ...
    private void addRowCollaboratorTable(ActionEvent event){
        try{
            ...
            if(validateNotRepeatCollaborator(collaborator)){
                WindowControllerB.getWindowController().showWarningAlert(event, "Este colaborador ya ha sido ingresado");
    ...
    private void addRowIntegrantTable(ActionEvent event){
        try{
            ...
            if(validateNotRepeatIntegrant(integrant)){
                WindowControllerB.getWindowController().showWarningAlert(event, "Este integrante ya ha sido ingresado");
    ...
    private void updateEvidence(ActionEvent event){
        try{
            ...
            if(EVIDENCE_DAO.updateEvidence(this.evidence, this.urlFileEvidence)){
                WindowControllerB.getWindowController().showInfoAlert(event, "Evidencia modificada con éxito");
            }else{
                WindowControllerB.getWindowController().showErrorAlert(event, "Error en el sistema, favor de ponerse en contacto con sopoerte técnico");
            }
